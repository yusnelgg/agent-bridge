...
echo ""
echo "   Frontend:  agent-bridge serve -config ~/.agent-bridge/frontend.yaml"
echo "   Backend:   AGENT_BRIDGE=http://localhost:9091 agent-bridge serve -config ~/.agent-bridge/backend.yaml"
echo ""
